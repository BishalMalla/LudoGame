...
//for green
var greenMoveArea = [23,38,53,68,83,99,100,101,102,103,104,119,134,133,132,131,130,129,143,158,173,188,203,218,217,216,201,186,171,156,141,125,124,123,122,121,120,105,90,91,92,93,94,95,81,66,51,36,21,6,7,22,37,52,67,82,97]
var pointerGreen = greenMoveArea[0];
var countGreen=0;

//for yellow
var yellowMoveArea =[133,132,131,130,129,143,158,173,188,203,218,217,216,201,186,171,156,141,125,124,123,122,121,120,105,90,91,92,93,94,95,81,66,51,36,21,6,7,8,23,38,53,68,83,99,100,101,102,103,104,119,118,117,116,115,114,113]
var pointerYellow = yellowMoveArea[0];
var countYellow=0;


//for blue
var blueMoveArea=[201,186,171,156,141,125,124,123,122,121,120,105,90,91,92,93,94,95,81,66,51,36,21,6,7,8,23,38,53,68,83,99,100,101,102,103,104,119,134,133,132,131,130,129,143,158,173,188,203,218,217,202,187,172,157,142,127]
...
function insideRedPlay(){
  ...
  if(countr!==6){
     countr=Math.floor(Math.random() * 6) + 1  ;
     if(iRed>0){
       result.html('You Rolled:' + countr);
       timer();
       iRed++;
...
function insideGreenPlay(){
  ...
  if(countg!==6){
    countg=Math.floor(Math.random() * 6) + 1  ;
    if(iGreen>0){
  ...
  var countG = Math.floor(Math.random() * 6) + 1  ;
...
function insideYellowPlay(){
  ...
  if(county!==6){
    county=Math.floor(Math.random() * 6) + 1  ;
    if(iYellow>0){
  ...
  var countY = Math.floor(Math.random() * 6) + 1  ;
